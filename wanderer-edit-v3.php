...
.fbtn { font-size: 11px; letter-spacing: 0.1em; text-transform: uppercase; color: var(--mist); background: transparent; border: 0.5px solid var(--border); padding: 8px 16px; cursor: pointer; transition: all 0.2s; font-family: var(--fb); }
.fbtn:hover, .fbtn.active { background: var(--dusk); color: var(--cream); border-color: var(--dusk); }
...
<div id="collection">
  <div class="col-header">
    ...
    <div class="filters">
      ...
      <button class="fbtn">Sling Bags</button>
      <button class="fbtn">Totes</button>
      <button class="fbtn">Clutches</button>
      <button class="fbtn">Crossbody</button>
    </div>
  </div>
  ...
  <div class="grid">
    ...
    <!-- #3 — IMG_1677: pink tassel bead clutch flat on sand, vibrant detail -->
    <div class="card">
      <div class="card-img">
    ...
    <!-- #9 — Lensa: rattan crossbody, golden grass background -->
    <div class="card">
      <div class="card-img">
    ...
    <!-- #10 — IMG_0639: evil eye tote bead close-up, pastel on black -->
    <div class="card">
      <div class="card-img">
        <img src="IMG_0639.jpeg" alt="Evil Eye Tote">
        <div class="badge b-ember">✦ The Statement</div>
        <div class="units">3 left</div>
        <button class="qadd">Add to Cart — ₹1,599</button>
      </div>
      <div class="cinfo">
        <div class="craft">Bead Embroidery · Stars & Eye</div>
        <div class="cname">The Midnight Eye Tote</div>
        <div class="cunique">Pastel evil eye, teardrop motifs, star and coin work on black canvas. The statement bag for every destination.</div>
        <div class="cfoot"><span class="cprice">₹1,599</span><span class="cship">Free returns</span></div>
      </div>
    </div>
